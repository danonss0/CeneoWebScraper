...
def products_list():
    lista = os.listdir("./app/static/opinions") 
    myList = [i.split('.')[0] for i in lista] 
    with open(f"./app/static/js/lista.json", "w", encoding="UTF-8") as file:
            json.dump(myList, file, indent=4,ensure_ascii=False)
